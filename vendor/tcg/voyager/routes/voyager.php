...
Route::group(['as' => 'voyager.'], function () {
    ...
    //Products
    Route::post('add-product', ['uses' => $namespacePrefix.'VoyagerProductController@create',  'as' => 'add_product']);

    Route::get('edit-product/{id}', ['uses' => $namespacePrefix.'VoyagerProductController@getEdit', 
                                                                     'as' => 'edit_product']);

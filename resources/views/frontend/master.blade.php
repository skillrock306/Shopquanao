		...
		<div class="sidebar flex-col-l p-t-22 p-b-25">
			...
			<div class="sidebar-content flex-w w-full p-lr-65 js-pscroll">
				<ul class="sidebar-link w-full">
					...
					@if(auth()->check())
						<li class="p-b-13">
							<a href="/account" class="stext-102 cl2 hov-cl1 trans-04">
								...
								<li class="header-cart-item flex-w flex-t m-b-12">
									...
									<div class="header-cart-item-txt p-t-8">
										<a href="#" class="header-cart-item-name m-b-18 hov-cl1 trans-04">
											{{ $item->name }}<br>
											@foreach ($item->attributes->data as $attribute)
			...
			<div class="row">
				...
				<div class="col-sm-6 col-lg-3 p-b-50">
					...
					<ul>
						@if(auth()->check())
						<li class="p-b-10">
							<a href="/account" class="stext-107 cl7 hov-cl1 trans-04">
								Xin chào {{auth()->user()->email }}
							</a>
						</li>
						<li class="p-b-10">
			...
			$.ajax({
	        	...
	        	if (msg == 'error') {
	        		...
	        		if (data.stock <= 0) {
	        			...
	        			if (data.isDiscount) {
	        				$('#price').addClass('discount');
	        				$('#discount-price').html(data.discount);
	        			} else {
	        				$('#price').removeClass('discount');
	        				$('#discount-price').html();
	        			}

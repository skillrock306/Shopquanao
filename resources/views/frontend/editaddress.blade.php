	...
	<div class="col-lg-10 col-xl-7 m-lr-auto m-b-50" style="width: 100%;" >
		<div class="wrap-table-shopping-cart" >
			<div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md" style="width: 80%;" >
				<form name="User-form" method="POST" action="index.php?view=myaccount&action=editaddress">
					<h4 class="mtext-105 cl2 txt-center p-b-30">
						Thông tin địa chỉ
					</h4>
					<div class="bor8 m-b-20 how-pos4-parent">
						<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="diachi_thanhvien" value="<?php echo $address['diachi_thanhvien']; ?>" placeholder="Địa chỉ">
					</div>
					<div class="bor8 m-b-20 how-pos4-parent">
					  	<select class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" name="macdinh">
					    	<option class="bor8 m-b-20 how-pos4-parent" value="1" <?php echo $address['macdinh'] == 1 ? 'selected=""' : '' ?>>Có</option>
					    	<option class="bor8 m-b-20 how-pos4-parent" value="0" <?php echo $address['macdinh'] == 0 ? 'selected=""' : '' ?>>Không</option>
						</select>
					</div>
					<div align="center">

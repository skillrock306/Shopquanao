...
@section('main')
	...
	<section class="sec-product-detail bg0 p-t-65 p-b-60">
					...
					<!--  -->
						<div class="p-t-33">
							<div class="flex-w flex-r-m p-b-10">
								...
								<div class="size-204 respon6-next">
									<div class="rs1-select2 bor8 bg0">
										<select class="js-select2" name="size" id="size" onchange="changeVariant(this);">
							...
							<div class="flex-w flex-r-m p-b-10">
								...
								<div class="size-204 respon6-next">
									<div class="rs1-select2 bor8 bg0">
										<select class="js-select2" name="color" id="color" onchange="changeVariant(this);">
							...
							<div class="flex-w flex-r-m p-b-10">
								<form action="/add-to-cart" method="POST" name="add-to-cart" id="add-to-cart">
									<div class="size-204 flex-w flex-m respon6-next">
										...
										{{ csrf_field() }}
										<button type="submit" class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04 js-addcart-detail" id="add-to-cart-btn">
											Add to cart
										</button>
									</div>
								</form>
		...
		<div class="bg6 flex-c-m flex-w size-302 m-t-73 p-tb-15">
			<span class="stext-107 cl6 p-lr-25" id="product-code">
